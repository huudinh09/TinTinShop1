	...
	<div class="grid wide">
		<div class="row">
			<div class="col l-2 m-0 c-0" >
				<div class="category">
					<h2 class="category-list">Danh mục sản phẩm</h2>
					<a class="category-name" href="#">Mỹ phẩm</a>
					<a class="category-name" href="#">Thực phẩm chức năng</a>
					<a class="category-name" href="#">Dược phẩm</a>
					<a class="category-name" href="#">Điện tử</a>
					<a class="category-name" href="#">Dã ngoại</a>
					<a class="category-name" href="#">Máy móc</a>
				</div>
			</div>
			<div class="col l-10 m-12 c-12" >
				<div class="content">
					<div class="row">
						<div class="card col l-2-4 m-3 c-4">
							<a href="./product.php">
								<div class="card-img">
								</div>
								<div class="card-name">KỆ GỖ - KỆ SÁCH GỖ 5 TẦNG ĐA NĂNG (KHO: KIMPHAM96) - GIÁ TỐT</div>
								<div class="cart-discount"></div>
								<div class="card-price"><u>đ</u>38.000</div>
